...
Reversing their order gives "jungle", "the", "to", and "welcome".  
...
Explanation:  
The input string has leading and trailing spaces, as well as multiple spaces between words.  
After trimming extra spaces and reducing multiple spaces to a single space, the words are  
"amazing", "coding", and "skills". Reversing their order gives "skills", "coding", and "amazing".  
